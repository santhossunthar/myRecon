...
sudo mysql $3 -e "insert into by4xx_HTTP_Methods (URL, GET, POST, HEAD, OPTIONS, PUT, TRACE, TRACK, CONNECT, PATCH) values ('$4', $GET, $POST, $HEAD, $OPTIONS, $PUT, $TRACE, $TRACK, $CONNECT, $PATCH)"
